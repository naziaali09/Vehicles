        ...
        public BaseClass() {
            try {
                ...
                FileInputStream in = new FileInputStream("C:\\Users\\nazia\\IdeaProjects\\" +
                        "Whiteboxqa\\src\\main\\java\\ConfigPackage\\Config.Properties");
                prop.load(in);
            ...
            String log4jpath =System.getProperty("user.dir")+"/src/main/resources/log4j/Log4j.Properties";
...
//String long4path =System.getProperty("user.dir")
//PropertyConfigurator.configure(log4jpath);
         */
            driver=new ChromeDriver();
